<%@ Page Title="" Language="C#" MasterPageFile="~/admin_home.master" AutoEventWireup="true" CodeFile="dues_reporting.aspx.cs" Inherits="dues_reporting" %>
 ...
 <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="index.aspx"><asp:LinkButton ID="LinkButton1" runat="server">Log out</asp:LinkButton></a></li>
                        ...
                        <br/>
                        <br/>
                           <h4 style="text-align:left;font-family:'Palatino Linotype';  color:#808080; padding-left:6%;">Dues Reporting</h4>
          </header><!-- #header -->
          ...
          <div class="container" style="margin-top: 10px;border: 1px solid #bcce98; color:black; padding-top:5%; padding-left:5%; padding-right:5%; font-family:Century"; height:"100%";">
                    ...
                    <p>
                       <br/>
                        ...
                        <table class="w-100">
                            <tr>
                                <td class="auto-style1">DuesFeeds Id&nbsp; :&nbsp;&nbsp;&nbsp; </td>
                                <td class="auto-style2">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Label ID="d_id" runat="server"></asp:Label>
                                </td>
