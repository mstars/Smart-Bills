<%@ Page Title="" Language="C#" MasterPageFile="~/admin_home.master" AutoEventWireup="true" CodeFile="student_details_view.aspx.cs" Inherits="student_details_view" %>
 ...
 <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="index.aspx"><asp:LinkButton ID="LinkButton1" runat="server">Log out</asp:LinkButton></a></li>
                        ...
                        <br/>
                        <br/>
                           <h4 style="text-align:left;font-family:'Palatino Linotype';  color:#808080; padding-left:6%;">Student Detail</h4>
          </header><!-- #header -->
                    ...
                    <p>
                       <br/>
                        ...
                        <br/>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:hbms_dbConnectionString %>" SelectCommand="SELECT * FROM [student_tab] WHERE ([test_confirm] = @test_confirm)">
                                        <SelectParameters>
                                            <asp:Parameter DefaultValue="confirmed" Name="test_confirm" Type="String" />
                                        </SelectParameters>
                        </asp:SqlDataSource>
