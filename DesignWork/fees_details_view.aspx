<%@ Page Title="" Language="C#" MasterPageFile="~/admin_home.master" AutoEventWireup="true" CodeFile="fees_details_view.aspx.cs" Inherits="fees_details_view" %>
 ...
 <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="index.aspx"><asp:LinkButton ID="LinkButton1" runat="server">Log out</asp:LinkButton></a></li>
                        ...
                        <br/>
                        <br/>
                           <h4 style="text-align:left;font-family:'Palatino Linotype';  color:#808080; padding-left:6%;">Fees Details</h4>
          </header><!-- #header -->
          ...
          <div class="container" style="margin-top: 10px;border: 1px solid #bcce98; color:black; padding-top:.5%; padding-left:5%; padding-right:5%; font-family:Century"; height:"100%";">
                    ...
                    <p>
                       <br/>
                        ...
                        <br/>
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataSourceID="SqlDataSource1" Width="871px">
                            <Columns>
                                <asp:BoundField DataField="room_type" HeaderText="Room Type" SortExpression="room_type" />
                                <asp:BoundField DataField="mess_rate" HeaderText="Mess Rate" SortExpression="mess_rate" />
                                <asp:BoundField DataField="water_power" HeaderText="Water and Power" SortExpression="water_power" />
                                <asp:BoundField DataField="room_rent" HeaderText="Room rent" SortExpression="room_rent" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:hbms_dbConnectionString %>" SelectCommand="SELECT * FROM [fees_structure_tab]"></asp:SqlDataSource>
                       <br />
                        <br /><br />
                        <br/>
                        <br/>
