<%@ Page Title="" Language="C#" MasterPageFile="~/admin_home.master" AutoEventWireup="true" CodeFile="dometry_billing_details.aspx.cs" Inherits="dometry_billing_details" %>
 ...
 <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="index.aspx"><asp:LinkButton ID="LinkButton1" runat="server">Log out</asp:LinkButton></a></li>
                        ...
                        <br/>
                        <br/>
                           <h4 style="text-align:left;font-family:'Palatino Linotype';  color:#808080; padding-left:6%;">Dometry Billing Details</h4>
          </header><!-- #header -->
          ...
          <div class="container" style="margin-top: 10px;border: 1px solid #bcce98; color:#bcce98; padding-top:5%; padding-left:5%; padding-right:5%; font-family:Century"; height:"100%";">
                    ...
                    <p>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataSourceID="SqlDataSource1" Width="850px">
                            <Columns>
                                <asp:BoundField DataField="did" HeaderText="Bill No" InsertVisible="False" ReadOnly="True" SortExpression="did" />
                                ...
                                <asp:TemplateField HeaderText="Click here">
                                    <ItemTemplate>
                                       <asp:LinkButton ID="LinkButton1" runat="server" CommandName="view" CommandArgument='<%# Eval("did") %>'>View</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:hbms_dbConnectionString %>" SelectCommand="SELECT * FROM [dometry_billing_tab]"></asp:SqlDataSource>
                        <br/>
                        <br/>
                        <br/>
