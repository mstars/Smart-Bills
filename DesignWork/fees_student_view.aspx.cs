...
public partial class fees_student_view : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if(Label5.Text.ToString()=="Double")
        {
            ...
            if (val == 1)
            {
                ...
                if (differenceInDays > 25 && differenceInDays  < 30)
                {

                    Label4.Visible = true;
                     Label4.Text = "Bill date is here"  ;
            ...
            if (val == 3)
            {
                ...
                if (differenceInDays > 85 && differenceInDays < 90)
                {
            ...
            if (val == 6)
            {
                ...
                if (differenceInDays > 175 && differenceInDays < 180)
                {
